...
from minimind_learning.trainer.trainer_utils import setup_seed
...
def main():
    ...
    parser.add_argument('--load_from', default='./src/model', type=str, help="模型加载路径（model=原生torch权重，其他路径=transformers格式）")
